            ...
            <div>
              ...
              <ShapChart
                data={selected.features ? [
                  { name: 'Отклонение суммы', effect: selected.features.amount_z_score, detail: `Z-Score: ${selected.features.amount_z_score}` },
                  { name: 'Гео-скорость', effect: selected.features.travel_speed > 900 ? selected.score / 150 : 0.1, detail: `${selected.features.travel_speed} км/ч` },
                  { name: 'Частота 1h', effect: selected.features.velocity_1h > 15 ? selected.score / 200 : -0.1, detail: `${selected.features.velocity_1h} транзакций` },
                ] : [
